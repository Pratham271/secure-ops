          ...
          <div className="px-6 py-6 space-y-8">
            ...
            <div>
              ...
              {!session ? (
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      {githubConnection.selectedRepo && (
                        <p className="text-xs text-green-700 mt-1">
                          Repository: {githubConnection.selectedRepo}
                        </p>
                      )}
                    </div>
                    <form
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-sm text-yellow-800 mb-3">
                    Connect your GitHub account to enable automatic ticket
                    creation
                  </p>
                  <form
                    action={async () => {
              ...
              <div className="mt-4 text-xs text-gray-500">
                <p className="font-medium mb-1">Why we need GitHub access:</p>
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>Create issues for incident tickets</li>
                  <li>Update issue status and labels</li>
            ...
            {githubConnection && (
              <div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <RepoSelector selectedRepo={githubConnection.selectedRepo} />
                </div>
              </div>
            )}
          </div>
